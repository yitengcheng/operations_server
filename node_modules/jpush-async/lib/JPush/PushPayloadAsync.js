...
function android (alert, title, builder_id, extras, priority, category, style, value, alertType, channel_id) {
  if (alert != null) {
...
function setOptions (sendno, time_to_live, override_msg_id, apns_production, big_push_duration, apns_collapse_id, third_party_channel) {
  if (sendno == null && time_to_live == null && override_msg_id == null && apns_production == null &&
    big_push_duration == null && third_party_channel == null) {
  ...
  if (third_party_channel != null) {
    if (typeof third_party_channel !== 'object') {
      throw new JError.InvalidArgumentError('Invalid options.third_party_channel, it can only be set to JSON Object')
    }
